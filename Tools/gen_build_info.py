...
FORK_ID = "EarthGov-Marine-Corps"
BUILD_URL = f"https://cdn.backmen.ru/builds-marine/{{FORK_VERSION}}/{FILE}"
MANIFEST_URL = f"https://cdn.backmen.ru/cdn-marine/version/{{FORK_VERSION}}/manifest"
MANIFEST_DOWNLOAD_URL = f"https://cdn.backmen.ru/cdn-marine/version/{{FORK_VERSION}}/download"
